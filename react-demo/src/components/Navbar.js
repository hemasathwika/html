  ...
  <div className="collapse navbar-collapse"
   id="navbarNavAltMarkup">
    <div className="navbar-nav">
      ...
      <NavLink className="nav-link active"aria-current="page" to="/emailinput">EmailInput</NavLink>
      <NavLink className="nav-link" to="/employees">Employees</NavLink>
      {/* <NavLink className="nav-link" to="/emailinput">Email Verification</NavLink> */}
